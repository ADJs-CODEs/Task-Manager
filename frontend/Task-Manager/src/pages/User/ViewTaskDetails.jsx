        ...
        {task && (<div className='grid grid-cols-1 md:grid-cols-4 mt-4'>
          <div className='form-card col-span-3'>
            <div className='flex items-center jsutify-between'>
              ...
              <div className={`ml-2 text-[11px] font-medium ${getStatusTagcolor(task?.status)
                }
              px-4 py-0.5 rounded`}>
                {task?.status}
              </div>
...
const Attachment = ({ link, index, onClick }) => {
  return <div
    className='flex justify-betweem bg-gray-50 border border-gray-100 px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer'
    onClick={onClick}>
